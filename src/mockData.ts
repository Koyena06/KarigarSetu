...
export const LANGUAGES: { key: Language; label: string; nativeLabel: string }[] = [
  ...
  { key: 'odia', label: 'Odia', nativeLabel: 'ଓଡ଼ିଆ' },
  { key: 'bengali', label: 'Bengali', nativeLabel: 'বাংলা' },
  { key: 'tamil', label: 'Tamil', nativeLabel: 'தமிழ்' },
  { key: 'telugu', label: 'Telugu', nativeLabel: 'తెలుగు' },
  { key: 'marathi', label: 'Marathi', nativeLabel: 'मराठी' },
  { key: 'gujarati', label: 'Gujarati', nativeLabel: 'ગુજરાતી' },
];
